...
const Toolkit = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 max-w-sm sm:max-w-lg mx-auto bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 p-3 rounded shadow shadow-xl">
